...
#stop docker
/usr/local/bin/docker compose -f /home/kepler/gkserver/docker-compose/docker-compose.yml stop

rsync -avhi --delete --backup-dir=$trashdir $src1 $dest1 2>&1| tee -a $logdest

#start docker
/usr/local/bin/docker compose -f /home/kepler/gkserver/docker-compose/docker-compose.yml start
